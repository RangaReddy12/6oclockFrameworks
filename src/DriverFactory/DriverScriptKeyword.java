...
String inputpath="E:\\630batch\\Selenium_FrameWorks\\TestInput\\Controller.xlsx";
String outputpath="E:\\630batch\\Selenium_FrameWorks\\TestOutput\\KeywordResults.xlsx";
...
for(int i=1;i<=TCCount; i++)
{
	...
	if(Execute.equalsIgnoreCase("Y"))
	{
		...
		for(int j=1;j<=TSCount;j++)
		{
			...
			{
				PBFunctions.clickBranches();
				res=PBFunctions.verifyBranchUpdate("Madanapalli", "Tanakal", "26547");
				test.log(LogStatus.INFO, Description);
			}
